...
module.exports = async (pluginConfig, context) => {
  ...
  logger.log(`Received repositoryUrl: ${repositoryUrl}`);
  logger.log(`Received repositoryUrlOverride: ${repositoryUrlOverride}`);
  ...
  const {repo, owner} = parseGithubUrl(repositoryUrlOverride || repositoryUrl);
  if (!owner || !repo) {
