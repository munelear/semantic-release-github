...
module.exports = async (pluginConfig, context) => {
  ...
  const [owner, repo] = (await github.repos.get(parseGithubUrl(repositoryUrlOverride || repositoryUrl))).data.full_name.split('/');
      ...
      uniqBy([...prs, ...issues], 'number').map(async (issue) => {
        ...
        try {
          ...
          if (releasedLabels) {
            ...
            // https://github.com/munelear/semantic-release-github/issues/138
